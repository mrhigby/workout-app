...
import { getRoutineById, getExerciseById, updateRoutine } from "@/lib/data-service";
...
export default function EditRoutinePage() {
  ...
  async function handleSave() {
    ...
    await updateRoutine(params.id as string, {
      name: name.trim(),
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Update your workout plan</p>
      </div>
